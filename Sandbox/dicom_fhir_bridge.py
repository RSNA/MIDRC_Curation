#Sandbox script that can take a directory of dicom files and convert to HL7 FHIR Resource types
...
if __name__ == '__main__':
    ...
    input_directory = "C:/Users/tosullivan/Documents/perso/siim/hackathon-images/Andy SIIM"
